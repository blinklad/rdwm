...
pub const ColBorder: C2RustUnnamed_2 = 2;
pub const ColBg: C2RustUnnamed_2 = 1;
pub const ColFg: C2RustUnnamed_2 = 0;
/* Clr scheme index */
...
pub const CurLast: C2RustUnnamed_3 = 3;
pub const CurMove: C2RustUnnamed_3 = 2;
pub const CurResize: C2RustUnnamed_3 = 1;
pub const CurNormal: C2RustUnnamed_3 = 0;
/* cursor */
pub type C2RustUnnamed_4 = libc::c_uint;
pub const SchemeSel: C2RustUnnamed_4 = 1;
pub const SchemeNorm: C2RustUnnamed_4 = 0;
/* color schemes */
pub type C2RustUnnamed_5 = libc::c_uint;
pub const NetLast: C2RustUnnamed_5 = 9;
pub const NetClientList: C2RustUnnamed_5 = 8;
pub const NetWMWindowTypeDialog: C2RustUnnamed_5 = 7;
pub const NetWMWindowType: C2RustUnnamed_5 = 6;
pub const NetActiveWindow: C2RustUnnamed_5 = 5;
pub const NetWMFullscreen: C2RustUnnamed_5 = 4;
pub const NetWMCheck: C2RustUnnamed_5 = 3;
pub const NetWMState: C2RustUnnamed_5 = 2;
pub const NetWMName: C2RustUnnamed_5 = 1;
pub const NetSupported: C2RustUnnamed_5 = 0;
/* EWMH atoms */
pub type C2RustUnnamed_6 = libc::c_uint;
pub const WMLast: C2RustUnnamed_6 = 4;
pub const WMTakeFocus: C2RustUnnamed_6 = 3;
pub const WMState: C2RustUnnamed_6 = 2;
pub const WMDelete: C2RustUnnamed_6 = 1;
pub const WMProtocols: C2RustUnnamed_6 = 0;
/* default atoms */
pub type C2RustUnnamed_7 = libc::c_uint;
pub const ClkLast: C2RustUnnamed_7 = 6;
pub const ClkRootWin: C2RustUnnamed_7 = 5;
pub const ClkClientWin: C2RustUnnamed_7 = 4;
pub const ClkWinTitle: C2RustUnnamed_7 = 3;
pub const ClkStatusText: C2RustUnnamed_7 = 2;
pub const ClkLtSymbol: C2RustUnnamed_7 = 1;
pub const ClkTagBar: C2RustUnnamed_7 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub union Arg {
    pub i: libc::c_int,
...
static mut handler: [Option<unsafe extern "C" fn(_: *mut XEvent) -> ()>; 36] =
    unsafe {
        [None, None,
         Some(keypress as unsafe extern "C" fn(_: *mut XEvent) -> ()), None,
         Some(buttonpress as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None,
         Some(motionnotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         Some(enternotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None, Some(focusin as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None, None,
         Some(expose as unsafe extern "C" fn(_: *mut XEvent) -> ()), None,
         None, None, None,
         Some(destroynotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         Some(unmapnotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None, Some(maprequest as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None,
         Some(configurenotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         Some(configurerequest as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None, None, None, None,
         Some(propertynotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None, None, None, None,
         Some(clientmessage as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         Some(mappingnotify as unsafe extern "C" fn(_: *mut XEvent) -> ()),
         None]
    };
        ...
        [{
             let mut init =
                 Layout{symbol:
                        ...
                        arrange:
                            Some(tile as
                                     unsafe extern "C" fn(_: *mut Monitor)
                                         -> ()),};
             init
         },
         {
...
unsafe extern "C" fn applysizehints(mut c: *mut Client,
 ...
 -> libc::c_int {
    ...
    *h = if 1i32 > *h { 1i32 } else { *h };
    ...
    if *h < bh { *h = bh }
    if *w < bh { *w = bh }
    if resizehints != 0 || (*c).isfloating != 0 ||
        ...
        *h =
        ...
        if (*c).maxw != 0 { *w = if *w < (*c).maxw { *w } else { (*c).maxw } }
        if (*c).maxh != 0 { *h = if *h < (*c).maxh { *h } else { (*c).maxh } }
    }
...
unsafe extern "C" fn checkotherwm() {
    xerrorxlib =
        XSetErrorHandler(Some(xerrorstart as
    ...
    XSelectInput(dpy,
                 ...
                 1i64 << 20i32);
    XSync(dpy, 0i32);
    XSetErrorHandler(Some(xerror as
                              unsafe extern "C" fn(_: *mut Display,
                                                   _: *mut XErrorEvent)
                                  -> libc::c_int));
    XSync(dpy, 0i32);
...
unsafe extern "C" fn clientmessage(mut e: *mut XEvent) {
    ...
    if (*cme).message_type == netatom[NetWMState as libc::c_int as usize] {
        if (*cme).data.l[1] as libc::c_ulong ==
               netatom[NetWMFullscreen as libc::c_int as usize] ||
               (*cme).data.l[2] as libc::c_ulong ==
                   netatom[NetWMFullscreen as libc::c_int as usize] {
            setfullscreen(c,
                          ((*cme).data.l[0] == 1i32 as libc::c_long ||
                               (*cme).data.l[0] == 2i32 as libc::c_long &&
                                   (*c).isfullscreen == 0) as libc::c_int);
        }
    } else if (*cme).message_type ==
                  netatom[NetActiveWindow as libc::c_int as usize] {
        if c != (*selmon).sel && (*c).isurgent == 0 { seturgent(c, 1i32); }
    };
}
...
unsafe extern "C" fn configurenotify(mut e: *mut XEvent) {
    ...
    if (*ev).window == root {
        dirty =
            (sw != (*ev).width || sh != (*ev).height) as
                libc::c_int; /* center in x direction */
        sw = (*ev).width; /* center in y direction */
        sh = (*ev).height;
        if updategeom() != 0 || dirty != 0 {
...
unsafe extern "C" fn configurerequest(mut e: *mut XEvent) {
    ...
    c = wintoclient((*ev).window);
    if !c.is_null() {
        if (*ev).value_mask & (1i32 << 4i32) as libc::c_ulong != 0 {
            (*c).bw = (*ev).border_width
        } else if (*c).isfloating != 0 ||
                      (*(*selmon).lt[(*selmon).sellt as
                                         usize]).arrange.is_none() {
            m = (*c).mon;
            if (*ev).value_mask & (1i32 << 0i32) as libc::c_ulong != 0 {
                (*c).oldx = (*c).x;
                (*c).x = (*m).mx + (*ev).x
            }
            if (*ev).value_mask & (1i32 << 1i32) as libc::c_ulong != 0 {
                (*c).oldy = (*c).y;
                (*c).y = (*m).my + (*ev).y
            }
            if (*ev).value_mask & (1i32 << 2i32) as libc::c_ulong != 0 {
                (*c).oldw = (*c).w;
                (*c).w = (*ev).width
            }
            if (*ev).value_mask & (1i32 << 3i32) as libc::c_ulong != 0 {
                (*c).oldh = (*c).h;
                (*c).h = (*ev).height
            }
            ...
            if (*ev).value_mask &
                   (1i32 << 0i32 | 1i32 << 1i32) as libc::c_ulong != 0 &&
                   (*ev).value_mask &
                       (1i32 << 2i32 | 1i32 << 3i32) as libc::c_ulong == 0 {
                configure(c);
            }
            if (*c).tags & (*(*c).mon).tagset[(*(*c).mon).seltags as usize] !=
                   0 {
...
unsafe extern "C" fn createmon() -> *mut Monitor {
    ...
    m =
        ecalloc(1i32 as size_t,
            ...
            *mut Monitor;
    (*m).tagset[1] = 1i32 as libc::c_uint;
    (*m).tagset[0] = (*m).tagset[1];
    (*m).mfact = mfact;
    (*m).nmaster = nmaster;
    (*m).showbar = showbar;
    (*m).topbar = topbar;
    (*m).lt[0] = &*layouts.as_ptr().offset(0) as *const Layout;
    (*m).lt[1] =
    ...
    strncpy((*m).ltsymbol.as_mut_ptr(), layouts[0].symbol,
            ::std::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong);
    return m;
}
...
unsafe extern "C" fn detachstack(mut c: *mut Client) {
    ...
    *tc = (*c).snext;
    if c == (*(*c).mon).sel {
        t = (*(*c).mon).stack;
        while !t.is_null() &&
                  (*t).tags & (*(*t).mon).tagset[(*(*t).mon).seltags as usize]
                      == 0 {
            t = (*t).snext
        }
        (*(*c).mon).sel = t
    ...
    while (i as libc::c_ulong) <
        ...
        w =
            drw_fontset_getwidth(drw,
                ...
                as libc::c_int;
        drw_setscheme(drw,
                      *scheme.offset((if (*m).tagset[(*m).seltags as usize] &
...
unsafe extern "C" fn focus(mut c: *mut Client) {
    if c.is_null() ||
        ...
        c = (*selmon).stack;
        while !c.is_null() &&
                  (*c).tags & (*(*c).mon).tagset[(*(*c).mon).seltags as usize]
                      == 0 {
            c = (*c).snext
        }
    }
    ...
    if !c.is_null() {
        ...
        if (*c).isurgent != 0 { seturgent(c, 0i32); }
        detachstack(c);
        attachstack(c);
        grabbuttons(c, 1i32);
...
unsafe extern "C" fn focusstack(mut arg: *const Arg) {
    ...
    if (*arg).i > 0i32 {
        ...
        i = (*selmon).clients;
        while i != (*selmon).sel {
            if (*i).tags & (*(*i).mon).tagset[(*(*i).mon).seltags as usize] !=
                   0 {
                c = i
            }
            i = (*i).next
        ...
        if c.is_null() {
            while !i.is_null() {
                if (*i).tags &
                       (*(*i).mon).tagset[(*(*i).mon).seltags as usize] != 0 {
                    c = i
                }
                i = (*i).next
            }
...
unsafe extern "C" fn gettextprop(mut w: Window, mut atom: Atom,
    ...
    *text.offset(0) = '\u{0}' as i32 as libc::c_char;
...
unsafe extern "C" fn killclient(mut arg: *const Arg) {
    if (*selmon).sel.is_null() { return }
    if sendevent((*selmon).sel, wmatom[WMDelete as libc::c_int as usize]) == 0
       {
        XGrabServer(dpy);
        XSetErrorHandler(Some(xerrordummy as
                                  unsafe extern "C" fn(_: *mut Display,
                                                       _: *mut XErrorEvent)
                                      -> libc::c_int));
...
unsafe extern "C" fn manage(mut w: Window, mut wa: *mut XWindowAttributes) {
    ...
    (*c).bw = borderpx as libc::c_int; /* some windows require this */
    ...
    if (*c).isfloating == 0 {
        (*c).oldstate =
            (trans != 0i64 as libc::c_ulong || (*c).isfixed != 0) as
                libc::c_int;
        (*c).isfloating = (*c).oldstate
    }
    if (*c).isfloating != 0 { XRaiseWindow(dpy, (*c).win); }
    attach(c);
    attachstack(c);
...
unsafe extern "C" fn maprequest(mut e: *mut XEvent) {
    ...
    if XGetWindowAttributes(dpy, (*ev).window, &mut wa) == 0 { return }
...
unsafe extern "C" fn monocle(mut m: *mut Monitor) {
    ...
    c = (*m).clients;
    while !c.is_null() {
        if (*c).tags & (*(*c).mon).tagset[(*(*c).mon).seltags as usize] != 0 {
            n = n.wrapping_add(1)
        }
        c = (*c).next
    }
...
unsafe extern "C" fn movemouse(mut arg: *const Arg) {
    ...
    if getrootptr(&mut x, &mut y) == 0 { return }
    loop  {
        XMaskEvent(dpy,
...
unsafe extern "C" fn nexttiled(mut c: *mut Client) -> *mut Client {
    while !c.is_null() &&
              ((*c).isfloating != 0 ||
                   (*c).tags &
                       (*(*c).mon).tagset[(*(*c).mon).seltags as usize] == 0)
          {
        c = (*c).next
    }
    return c;
...
unsafe extern "C" fn resizemouse(mut arg: *const Arg) {
    ...
    XWarpPointer(dpy, 0i64 as Window, (*c).win, 0i32, 0i32,
                 ...
                 (*c).w + (*c).bw - 1i32, (*c).h + (*c).bw - 1i32);
    XUngrabPointer(dpy, 0i64 as Time);
    while XCheckMaskEvent(dpy, 1i64 << 4i32, &mut ev) != 0 { }
    m = recttomon((*c).x, (*c).y, (*c).w, (*c).h);
    if m != selmon { sendmon(c, m); selmon = m; focus(0 as *mut Client); };
}
...
unsafe extern "C" fn scan() {
    ...
    if XQueryTree(dpy, root, &mut d1, &mut d2, &mut wins, &mut num) != 0 {
        i = 0i32 as libc::c_uint;
        while i < num {
            if !(XGetWindowAttributes(dpy, *wins.offset(i as isize), &mut wa)
                     == 0 || wa.override_redirect != 0 ||
        ...
        while i < num {
            ...
            if !(XGetWindowAttributes(dpy, *wins.offset(i as isize), &mut wa)
                     == 0) {
                if XGetTransientForHint(dpy, *wins.offset(i as isize),
                                        &mut d1) != 0 &&
                       (wa.map_state == 2i32 ||
                            getstate(*wins.offset(i as isize)) ==
                                3i32 as libc::c_long) {
                    manage(*wins.offset(i as isize),
                           &mut wa); /* assign tags of target monitor */
                }
            }
            i = i.wrapping_add(1)
        }
...
unsafe extern "C" fn sendevent(mut c: *mut Client, mut proto: Atom)
 -> libc::c_int {
    ...
    if XGetWMProtocols(dpy, (*c).win, &mut protocols, &mut n) != 0 {
        while exists == 0 && { let fresh1 = n; n = n - 1; fresh1 != 0 } {
    ...
    if exists != 0 {
        ...
        ev.xclient.data.l[0] = proto as libc::c_long;
        ev.xclient.data.l[1] = 0i64;
...
unsafe extern "C" fn setfullscreen(mut c: *mut Client,
    ...
    if fullscreen != 0 && (*c).isfullscreen == 0 {
    ...
    } else if fullscreen == 0 && (*c).isfullscreen != 0 {
        XChangeProperty(dpy, (*c).win,
                        netatom[NetWMState as libc::c_int as usize],
...
unsafe extern "C" fn setup() {
    ...
    while (i as libc::c_ulong) <
              (::std::mem::size_of::<[[*const libc::c_char; 3]; 2]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<[*const libc::c_char; 3]>()
                                                   as libc::c_ulong) {
        let ref mut fresh2 = *scheme.offset(i as isize);
        *fresh2 =
...
unsafe extern "C" fn sigchld(mut unused: libc::c_int) {
    if signal(17i32,
              Some(sigchld as unsafe extern "C" fn(_: libc::c_int) -> ())) ==
...
unsafe extern "C" fn togglebar(mut arg: *const Arg) {
    (*selmon).showbar = ((*selmon).showbar == 0) as libc::c_int;
    updatebarpos(selmon);
...
unsafe extern "C" fn togglefloating(mut arg: *const Arg) {
    ...
    (*(*selmon).sel).isfloating =
        ((*(*selmon).sel).isfloating == 0 || (*(*selmon).sel).isfixed != 0) as
            libc::c_int; /* restore border */
    ...
    let mut ch: XClassHint =
        {
            let mut init =
                XClassHint{res_name:
                               b"dwm\x00" as *const u8 as *const libc::c_char
                                   as *mut libc::c_char,
                           res_class:
                               b"dwm\x00" as *const u8 as *const libc::c_char
                                   as *mut libc::c_char,};
...
unsafe extern "C" fn updatebarpos(mut m: *mut Monitor) {
    ...
    if (*m).showbar != 0 {
        (*m).wh -= bh;
        (*m).by = if (*m).topbar != 0 { (*m).wy } else { (*m).wy + (*m).wh };
...
unsafe extern "C" fn updategeom() -> libc::c_int {
        ...
        unique =
            ecalloc(nn as size_t,
                    ::std::mem::size_of::<XineramaScreenInfo>() as
                        libc::c_ulong) as
                *mut XineramaScreenInfo; /* less monitors available nn < n */
        i = 0i32;
        j = 0i32;
        while i < nn {
            if isuniquegeom(unique, j as size_t,
                            &mut *info.offset(i as isize)) != 0 {
                let fresh3 = j;
                j = j + 1;
                memcpy(&mut *unique.offset(fresh3 as isize) as
    ...
    if dirty != 0 { selmon = mons; selmon = wintomon(root) }
    return dirty;
}
...
unsafe extern "C" fn updatesizehints(mut c: *mut Client) {
    ...
    if size.flags & 1i64 << 8i32 != 0 {
        (*c).basew = size.base_width;
        (*c).baseh = size.base_height
    } else if size.flags & 1i64 << 4i32 != 0 {
        (*c).basew = size.min_width;
        (*c).baseh = size.min_height
    } else { (*c).baseh = 0i32; (*c).basew = (*c).baseh }
    if size.flags & 1i64 << 6i32 != 0 {
        (*c).incw = size.width_inc;
        (*c).inch = size.height_inc
    } else { (*c).inch = 0i32; (*c).incw = (*c).inch }
    if size.flags & 1i64 << 5i32 != 0 {
        (*c).maxw = size.max_width;
        (*c).maxh = size.max_height
    } else { (*c).maxh = 0i32; (*c).maxw = (*c).maxh }
    if size.flags & 1i64 << 4i32 != 0 {
        (*c).minw = size.min_width;
        (*c).minh = size.min_height
    } else if size.flags & 1i64 << 8i32 != 0 {
        (*c).minw = size.base_width;
        (*c).minh = size.base_height
    } else { (*c).minh = 0i32; (*c).minw = (*c).minh }
    if size.flags & 1i64 << 7i32 != 0 {
        (*c).mina =
    ...
    (*c).isfixed =
        ((*c).maxw != 0 && (*c).maxh != 0 && (*c).maxw == (*c).minw &&
             (*c).maxh == (*c).minh) as libc::c_int;
}
unsafe extern "C" fn updatestatus() {
    if gettextprop(root, 39i32 as Atom, stext.as_mut_ptr(),
...
unsafe extern "C" fn updatetitle(mut c: *mut Client) {
    if gettextprop((*c).win, netatom[NetWMName as libc::c_int as usize],
                   (*c).name.as_mut_ptr(),
                   ::std::mem::size_of::<[libc::c_char; 256]>() as
                       libc::c_ulong as libc::c_uint) == 0 {
    ...
    if (*c).name[0] as libc::c_int == '\u{0}' as i32 {
        /* hack to mark broken clients */
        strcpy((*c).name.as_mut_ptr(),
               broken.as_ptr()); /* toggle sel tagset */
    };
}
...
unsafe extern "C" fn updatewmhints(mut c: *mut Client) {
    ...
    wmh = XGetWMHints(dpy, (*c).win);
    if !wmh.is_null() {
        if c == (*selmon).sel && (*wmh).flags & 1i64 << 8i32 != 0 {
            (*wmh).flags &= !(1i64 << 8i32);
            XSetWMHints(dpy, (*c).win, wmh);
        } else {
            (*c).isurgent =
                if (*wmh).flags & 1i64 << 8i32 != 0 { 1i32 } else { 0i32 }
        }
        if (*wmh).flags & 1i64 << 0i32 != 0 {
            (*c).neverfocus = ((*wmh).input == 0) as libc::c_int
...
unsafe extern "C" fn zoom(mut arg: *const Arg) {
    ...
    if (*(*selmon).lt[(*selmon).sellt as usize]).arrange.is_none() ||
           !(*selmon).sel.is_null() && (*(*selmon).sel).isfloating != 0 {
        return
    }
        ...
        [{
             let mut init =
                 Key{mod_0: (1i32 << 3i32) as libc::c_uint,
                     ...
                     func:
                         Some(spawn as
                                  unsafe extern "C" fn(_: *const Arg) -> ()),
                     arg:
                         Arg{v:
                                 dmenucmd.as_mut_ptr() as
                                     *const libc::c_void,},};
             init
         },
         {
         ...
         },
         {
             let mut init =
                 Key{mod_0: (1i32 << 3i32) as libc::c_uint,
                     ...
                     arg:
                         Arg{v:
                                 &*layouts.as_ptr().offset(0) as *const Layout
         ...
         },
         {
             let mut init =
                 Key{mod_0: (1i32 << 3i32) as libc::c_uint,
                     ...
                     arg:
                         Arg{v:
                                 &*layouts.as_ptr().offset(1) as *const Layout
                                     as *const libc::c_void,},};
             init
         },
         {
             let mut init =
                 Key{mod_0: (1i32 << 3i32) as libc::c_uint,
                     ...
                     arg:
                         Arg{v:
                                 &*layouts.as_ptr().offset(2) as *const Layout
                                     as *const libc::c_void,},};
             init
         },
         {
